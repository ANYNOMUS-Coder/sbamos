        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading tableheadng">
                    ...
                    echo ($isDeleted=='Y') ? '<button class="btn btn-sm" type="button">'.$totalRow.'</button> DELETED SMTP&nbsp;' : '<button class="btn btn-sm" type="button">'.$totalRow.'</button> SMTP&nbsp;';
                    echo ($isDeleted=='Y') ? '
                        <a href="'.$SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtaction='.$dtaction.'" class="btn btn-success btn-sm pull-right"><i class="fa fa-users" aria-hidden="true"></i> See SMTP list</a>  
                    ' : '
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="">
                                    <div class="th-inner sortable"> Smtp Host
                                    </div>
                                </th>
								<th style="">
                                    <div class="th-inner sortable"> Smtp Username
                                    </div>
                                </th>
                                <th style="">
                                    <div class="th-inner sortable"> Smtp Password
                                    </div>
                                </th>
                        ...
                        $ftrData = $obj ->getSmtpConfiguration($ExtraQryStr,$start,$limit);
                        $totalRow = $obj -> existSmtpConfiguration($ExtraQryStr);
                        ...
                        if($ftrData){
                            foreach($ftrData as $bdk=>$bdv){
                                ...
                                $activecolor = ($bdv['isActivated']=='Y') ? 'style="color:#54C761"': 'style="color:#cccccc"';
                                ?>
                                <tr id="<?php echo $bdv['smtpId'];?>" >
                                    <!--<td class="bs-checkbox">
                                        <input type="checkbox" name="toolbar1" data-index="0">
                                    </td>-->
                                    <td style=""><?php echo (($page-1)*$limit)+1+$bdk;?></td>
                                    <td style="">
                                        <a href="<?php echo $SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtls='.$dtaction.'&dtaction=add&editid='.$bdv['smtpId'].'&redirect='.base64_encode($redirectString);?>">
                                            <?php echo $bdv['smtpHost'];?>
                                        </a>
                                    </td>
                                  
								    <td style="">
                                        <?php echo $bdv['smtpUsername'];?>
										 
                                    </td>	
											
								    <td style="">
                                        <?php echo $bdv['smtpPassword'];?>
                                    </td>	
                                    <td style="">
                                        <a title="Activate" class="listsetting" href="<?php echo $SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtls='.$dtaction.'&dtaction=activate&editid='.$bdv['smtpId'].'&redirect='.base64_encode($redirectString);?>" <?php echo $activecolor;?> >
                                            <i class="fa fa-circle" aria-hidden="true"></i>
                                        </a>
                                        
                                        <a title="Edit" class="listsetting" href="<?php echo $SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtls='.$dtaction.'&dtaction=add&editid='.$bdv['smtpId'].'&redirect='.base64_encode($redirectString);?>">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </a>
                                        
                                        <a title="status" class="listsetting" href="<?php echo $SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtls='.$dtaction.'&dtaction=status&chngid='.$bdv['smtpId'].'&strchngto='.$strchngto.'&redirect='.base64_encode($redirectString);?>">
                                            <?php echo $stsImg;?>
                                        </a>
                                        
                                        <a title="Delete" class="listsetting deletealert" data-alartmsg="Are you sure? " href="<?php echo $SITE_LOC_PATH.'/admin/?pageType='.$pageType.'&dtls='.$dtaction.'&dtaction=delete&deleteid='.$bdv['smtpId'].'&redirect='.base64_encode($redirectString);?>">
