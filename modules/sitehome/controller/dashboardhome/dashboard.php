                                                ...
                                                <table class="table select-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex ">
                                                                    <img src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face1.jpg" alt="">
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face2.jpg" alt="">
                                                                    <div>
                                                                        <h6>Laura Brooks</h6>
                                                                        <p>Head admin</p>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face3.jpg" alt="">
                                                                    <div>
                                                                        <h6>Wayne Murphy</h6>
                                                                        <p>Head admin</p>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face4.jpg" alt="">
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face5.jpg" alt="">
                                                                    <div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="mt-3">
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face1.jpg" alt="profile">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face2.jpg" alt="profile">
                                                                <div class="wrapper ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face3.jpg" alt="profile">
                                                                <div class="wrapper ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face4.jpg" alt="profile">
                                                                <div class="wrapper ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="'.$SITE_LOC_PATH.'/admin/templates/images/faces/face5.jpg" alt="profile">
                                                                <div class="wrapper ms-3">
